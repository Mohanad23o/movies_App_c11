...
import '../category_details/Categorized_Movie_Item.dart';
        ...
        child: Stack(
            children: [
                 ColorFiltered(colorFilter: ColorFilter.mode(
                  ...
                  BlendMode.darken,),
                  child:
             Image.asset('assets/images/categories/${genre.name}.jpg',
              ...
              Center(
                child: Text(genre.name ?? '',style:Theme.of(context).textTheme.displayLarge,
